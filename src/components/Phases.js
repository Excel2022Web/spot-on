...
export const Phases = () => {
  ...
  const phaseNumberStyle = "text-center text-[28px] md:text-[30px] font-semibold";
  ...
  return (
      <div className="bg-[#1E2029] text-white px-2 md:px-10 md:h-100 ">
          ...
          <div className={phaseCardStyle}>
                  ...
                  Participants will be organized into groups for a structured group discussion.
                  <br/><br/>
                  Each group will be provided with a topic beforehand & each participant should present their points at their turns.
                    <br/><br/>
Time for discussion prior to the presentation will be provided.
              ...
              <div className={phaseCardStyle}>
                  ...
                  <hr className='solid bg-white  mx-auto w-50'/>
                  <p className={phaseDescriptionStyle}>
                      Those participants who have qualified from the previous
                      round are eligible for this phase.
                      <br />
                      <br />
                      Speak for and against a topic for one-minute intervals.
                      <br />
                      <br />
                      Time for preparation prior to the presentation will be
                      provided.
                  </p>
              </div>
              <div className={phaseCardStyle}>
                  ...
                  <p className={phaseDescriptionStyle}>
                      ...
                      <br />
                      <br />
                      Analyze & interpret an image shown on the screen &
                      prepare your points within 3 mins.
                      <br />
                      <br />
                      Present your insights & points about the image for the
