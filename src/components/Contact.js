...
export const Contact = () => {
  ...
  <div class="text-container">
    ...
    <a href=''><img src={phone} className="h-[15px] w-[15px]"/></a>
        <a href=''><img src={email} className="h-[15px] w-[15px]"/></a>
        <a href=''><img src={linkedin}  className="h-[15px] w-[15px]"/></a>
    </div>
    <div>
  ...
  <div class="text-container">
    ...
    <div className="bg-[#1E2029] min-h-[344px]  text-white p-5 md:px-5 md:py-0 flex flex-col justify-evenly items-center gap-8 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-4">
            ...
            <div className="flex flex-row justify-end items-center gap-4 md:gap-16 md:col-end-3 md:row-start-1">
                <a><img className="h-[32px] w-[32px]" src={facebook} /></a>
                <a><img className="h-[32px] w-[32px]" src={instagram} /></a>
                <a><img className="h-[32px] w-[32px]" src={twitter} /></a>
                <a><img className="h-[32px] w-[32px]" src={linkedin} /></a>
